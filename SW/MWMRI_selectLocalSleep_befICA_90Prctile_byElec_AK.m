...
%files=dir([data_path filesep filesep 'MWMRI*visins_edf_beforeICAepochallChannels.set']);
...
for nF=1:length(files)
    ...
    SubID=files(nF).name;
    %sep=findstr(SubID,'visins_edf_beforeICAepochallChannels.set');
    ...
    if exist([save_path filesep 'prct_RPA_SW_' SubID '.mat'])==0
        continue;
    end
...
%     end
    ...
    load([save_path filesep 'prct_RPA_SW_' SubID ])
    ...
    %save([save_path filesep 'prct_SW_' SubID],'slow_Waves','paramSW','ChanLabels')
