...
AllCorr(:,:,k)=correlationMatrix;

correlationMatrix = mean(AllCorr,3);
...
%title(['Posterior ROI Time courses correlation - ' SubID]);
title(['Posterior ROI Time courses correlation - AVERAGE' ]);
format_fig
figsavepath = ['/Users/kuszti/Documents/Git/MW_IRM/SW/Figures/posteriorTCcorr_', SubID ,'.fig'];
savefig(figsavepath);
